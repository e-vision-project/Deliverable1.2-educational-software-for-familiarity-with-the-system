...
namespace FrostweepGames.Plugins.GoogleCloud.SpeechRecognition
{
    public class GCSpeechRecognition : MonoBehaviour
    {
        ...
        private void TalkEndedEventHandler(AudioClip clip)
        {
#if !NET_2_0 && !NET_2_0_SUBSET
			EndTalkigEvent?.Invoke(clip);
#else
        ...
        private void RecordEndedEventHandler(AudioClip clip)
		{
#if !NET_2_0 && !NET_2_0_SUBSET
			FinishedRecordEvent?.Invoke(clip);
#else
