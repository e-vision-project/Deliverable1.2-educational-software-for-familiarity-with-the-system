...
namespace FrostweepGames.Plugins.GoogleCloud.SpeechRecognition
{
    public interface IMediaManager
    {
		...
		event Action<AudioClip> RecordEndedEvent;

		event Action TalkBeganEvent;
		event Action<AudioClip> TalkEndedEvent;
		...
		IEnumerator OneTimeRecord(int durationSec, Action<AudioClip> callback, int sampleRate = 16000);
