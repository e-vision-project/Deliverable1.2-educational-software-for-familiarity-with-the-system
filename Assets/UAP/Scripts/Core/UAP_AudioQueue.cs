...
public class UAP_AudioQueue : MonoBehaviour
{
    ...
    /// <summary>
    /// Speech Pitch in the range of 0..1, not supported on all platforms.
    /// </summary>
    private float m_SpeechPitch = 1;
	...
	{
		m_SpeechRate = PlayerPrefs.GetInt("SpeechTone");
        m_SpeechPitch = PlayerPrefs.GetFloat("SpeechPitch");
	...
	public int SetSpeechRate(int speechRate)
	{
        ...
        AppManager.SetVoiceSpeed(m_SpeechRate);
